...
trainAvgB1= csvread('C:\Users\Rachita\Documents\MATLAB\Baseline1_Training.csv',1,1);
trainAvgB2= csvread('C:\Users\Rachita\Documents\MATLAB\Baseline2_Training.csv',1,1);
...
trainB1B2Avg = (trainAvgPart1)*0.1 + (trainAvgPart2)*0.9;
trainActual = horzcat(trainB1B2Avg,trainAvgB1(1:600,2417:3171),trainAvgB2(1:600,2417:2553));

test_B1Avg=csvread('C:\Users\Rachita\Documents\MATLAB\Baseline1_Testing(1).csv',1,1);
test_B2Avg=csvread('C:\Users\Rachita\Documents\MATLAB\Baseline2_Testing.csv',1,1);
...
train_labelAB1B2Avg=csvread('C:\Users\Rachita\Documents\MATLAB\DM\Training_Label.txt', 0,0,[0 0 539 0]);
...
labelAcurracyAB1B2Avg= csvread('C:\Users\Rachita\Documents\MATLAB\Training_Label.txt', 540,0,[540 0 599 0]);
